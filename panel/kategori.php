      ...
      <div class="sect-col-half">
         ...
         <form action="actions/create-cat.php" method="post">
            <div class="form-group">
               ...
               <input type="text" required name="name" placeholder="Misal: Ikan Hias">
            </div>
            <div class="form-group">
               <label>Deskripsi</label>
               <textarea name="desc" placeholder="Misal: Ikan ini kalo digoreng gak enak. Cocoknya dipajang jadi dekor rumah"></textarea>
            </div>
            <div class="form-group">
               <label>Tampilkan?</label>
               <select required name="show">
                  <option value="1">YA</option>
                  <option value="0">NGGAK</option>
               </select>
            </div>
            <div class="form-group">
