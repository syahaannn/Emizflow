      ...
      <div class="sect-body">
         <div class="sect-col-half">
            ...
            if(!empty($_GET['create']))
            {
               ...
               {
                  ?>
                  <h4 class="alert alert-success">Selamat akun berhasil dibuat!</h4>
                  <?php
               }
               else{
                  ?>
                  <h4 class="alert alert-danger">MAAF akun sudah ada!</h4>
                  <?php
               }
            }
            ?>
            <form action="actions/create-acc.php" method="post">
               <div class="form-group">
                  ...
                  <input type="text" required name="name" placeholder="Misal: mizu">
               </div>
               <div class="form-group">
                  <label>E-Mail</label>
                  <input type="email" required name="email" placeholder="Misal: mizuflowerhorn@gmail.com">
               </div>
               <div class="form-group">
                  <label>Sandi</label>
