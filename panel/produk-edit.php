...
<html lang="id">
<head>
   <title>Panel - Tambah Produk</title>
      ...
      <div class="sect-col-half">
         <form action="actions/update-produk.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
               ...
               <input type="text" required name="name" placeholder="Ikan Cupang" value="<?= $produk['nama'] ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <textarea name="descript" required placeholder="Produk ini sangat tidak bagus"><?= $produk['deskripsi'] ?></textarea>
            </div>
            <div class="form-group">
               <label>Harga</label>
