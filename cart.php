...
<body style="padding:0;margin:0;box-sizing: border-box;font-family: 'Rubiks'">
   ...
   <div class="wrapper-cart" style="padding-bottom: 100px;">
      <h1><i class="fas fa-shopping-cart"></i> Keranjang Pembelian</h1>
            ...
            while($fetchCart = mysqli_fetch_array($getCart['result']))
            {
               ...
               <div>
                  ...
                  <div>
                     ...
                     <a href="produk.php?id=<?= $getPrd['id_data'] ?>" style="font-size:14px;color:orange;text-decoration: none;background: orange;color:white;padding:5px;">Pesan Lagi</a>
                  </div>
               </div>
               <?php
            }
      ...
      {
         ?>
         <a style="text-transform:uppercase;margin-top:10px;padding:15px;float:left;background: lightseagreen;color:#fff;text-decoration: none" href="backend/checkout.php">Selesaikan Pembayaran</a>
         <?php
      }
      ?>
   </div>
