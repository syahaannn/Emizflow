   ...
   <form action="backend/to-cart.php" method="post">
      <div class="prd-wrapper">
         ...
         <div class="">
            ...
            <h3>Stok: <?= number_format($prd['qty']) ?></h3>
            <hr>
            ...
            if(!empty($_SESSION['user']))
            {
               ...
               <button type="button" class="open-popup" data-target=".nav-login" style="padding:15px;border-radius:5px;background: orange;border:none;color:#fff;"><i class="fas fa-shopping-cart"></i> Masuk Keranjang</button>
               <?php
            }
            ?>
