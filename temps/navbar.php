<div class="navbar">
   <div class="nav-group">
      <a href="index.php"><img src="image/logo.png" style="padding:5px;background:black;border-radius:100px;width:50px;height:50px;object-fit: contain"></a>
   </div>
   <div class="nav-group flex-center">
      <a href="index.php"><i class="fas fa-home"style="color: white"></i></a>
      <a href="#" class="opencat" data-target=".nav-cont-cat"style="color: white;border: #ddd">Kategori</a>
      <a href="#" class="opencat" data-target=".nav-cont-src" style="border-right:1px solid #ddd;margin-right:20px;padding-right:20px;color: white"><i class="fas fa-search"></i></a>
      <?php
      if(!empty($_SESSION['user']))
      {
         ...
         else if($_SESSION['level'] == "admin")
         {
            ...
            <a style="margin-right:5px;width:25px;height:25px;text-align: center;display: flex;flex-flow: row;align-items: center;align-content: center;justify-content: center" class="nav-acc" href="transhistory.php"><i class="fas fa-clock"></i></a>
            <a style="margin-right:5px;width:25px;height:25px;text-align: center;display: flex;flex-flow: row;align-items: center;align-content: center;justify-content: center" class="nav-acc" href="cart.php"><i class="fas fa-shopping-cart"></i></a>
            <a style="margin-right: 5px;" class="nav-acc" href="panel/dash.php"><i class="fas fa-user"></i> Panel</a>
         ...
         ?>
         <a class="nav-acc" data-target=".nav-login" href="#">Masuk</a>
         <a class="nav-acc" data-target=".nav-register" href="#">Daftar</a>
         <?php
      }
      ?>
   </div>
