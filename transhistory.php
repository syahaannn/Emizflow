   ...
   <div class="wrapper-cart" style="padding-bottom: 100px;">
      ...
      <div class="hist-items">
         ...
         while($fgr = mysqli_fetch_array($group['result']))
         {
            ...
            ?>
            <div class="reg-group">
               <p style="margin:0;padding:10px;background: orange;color:#fff;margin:10px;border-radius: 5px;">
               ...
               ?>
               <h3 style="padding:10px;background: lightseagreen;color:#fff;margin:10px;padding:20px;">Total Harga: Rp.<?= number_format($totalGroup) ?></h3>
               <?php
               if($status['rows'] == 0)
               {
                  if($upStatus['rows'])
                  {
                     ...
                     {
                        ?>
                        <h3 style="padding:10px;color:orange;">Bukti Pembayaran Sedang diverifikasi...</h3>
                        <?php
                     }
                  }
                  else{
                    ...
                    <p style="font-size:16px;color:#333;">
                       ...
                       Nama Bank: <b>BANK BCA</b><br>
                       A/N: <b>mizu flowerhorn</b><br>
                       No. Rekening: <b>0123-4567-6969</b><br><br>
